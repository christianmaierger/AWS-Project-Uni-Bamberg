...
*/
const {docClient, TableName, GSI2Name, errorType} = require("../../shared");
console.log('Loading function');

exports.userAuthorizer = async function(event, context, callback) {
    ...
    try {
        response = await docClient
            .query({
                TableName: TableName,
                IndexName: GSI2Name,
                KeyConditionExpression: 'secret = :secret', // KeyConditionExpression using indexed attributes
